...
class DescriptionResource(ConfiguredBaseModel):
    ...
    @validator('last_modified', allow_reuse=True)
...
WorkVariant.update_forward_refs()
GeographicName.update_forward_refs()
...
Extent.update_forward_refs()
Format.update_forward_refs()
Audio.update_forward_refs()
DigitalFile.update_forward_refs()
DigitalFileEncoding.update_forward_refs()
Film.update_forward_refs()
Optical.update_forward_refs()
Video.update_forward_refs()
Manifestation.update_forward_refs()
Language.update_forward_refs()
Item.update_forward_refs()
MovingImageRecordCollection.update_forward_refs()
AuthorityResource.update_forward_refs()
AVefiResource.update_forward_refs()
DOIResource.update_forward_refs()
FilmportalResource.update_forward_refs()
GNDResource.update_forward_refs()
ISILResource.update_forward_refs()
TGNResource.update_forward_refs()
VIAFResource.update_forward_refs()
WikidataResource.update_forward_refs()
